...
def predict_runtime(planList, qname="q", type="spark3"):
    ...
    print("Algorithm 1 cost {} seconds".format(elapsed_time))
...
if __name__ == "__main__":
    ...
    while i <= 99:
        ...
        try:
            ...
            print("before the broadcastExchange overead: the predicted runtime is {} seconds".format(predicted_runtime))
        ...
        break
        # i = i + 1
    query_i = "query_"+str(i)
    # query_i = "motivation2_"
    print(content)
    elapsed_time = time.time() - start

    print("elapsed_time is {} seconds".format(elapsed_time))
    # prefix = query_i+"TPC-DS-500GB-" + configs_str
