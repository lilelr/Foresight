...
from tpch_stage import FirstStage, BroadcastStage, NormalStage, Stage
...
if __name__ == "__main__":
    ...
    # for i in particular_cases:
        ...
        try:
            ...
            depth, predicted_runtime = predict_runtime(planList, qname=fileName + "_operators")  # 检查有无
            new_line = '{},{},{}\n'.format(i,depth,predicted_runtime)
            print("prediction: "+new_line)
            content+=new_line
        except Exception as e:
            print(e)
        i = i + 1

    fileName = 'TPC-H-runtime_predition-500GB.csv'
    with open(fileName, 'w')as file:
        file.write(content)
    print("TPC-H testing finished")
