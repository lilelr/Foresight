...
def parse_options():
    ...
    parser.add_argument("--datasize", default=500, type=int, help='data size')
    parser.add_argument("--query", default=94, type=int, help='the index of TPC-DS query')
    parser.add_argument("--deadline", default=3, type=int, help='the deadline in minutes', )
...
if __name__ == "__main__":
    ...
    deadline = opt.deadline * 60
    print("Foresight predicts whether the deadline {} seconds of query-{} can be met at {}GB scale".format(deadline,i,data_size))
    ...
    content += "\n"
    while i <= 99:
        # for i in particular_cases:        # if i == 44 or i == 46:
        #     i += 1
        #     continue
        # fileName = "../results/tpcds-99queries/q21-30/q"+str(i)+"_100.plan"
        fileName = ""
        if 1 <= i <= 10:
            fileName = "../results/tpcds-99queries/q1-10/q" + str(i) + "_500.plan"
        elif 11 <= i <= 20:

            fileName = "../results/tpcds-99queries/q11-20/q" + str(i) + "_500.plan"
        elif 21 <= i <= 30:
            fileName = "../results/tpcds-99queries/q21-30/q" + str(i) + "_500.plan"
        elif 31 <= i <= 40:
            fileName = "../results/tpcds-99queries/q31-40/q" + str(i) + "_500.plan"
        elif 41 <= i <= 50:
            fileName = "../results/tpcds-99queries/q40-49/q" + str(i) + "_500.plan"
        elif 51 <= i <= 60:
            fileName = "../results/tpcds-99queries/q50-60/q" + str(i) + "_500.plan"
        elif 61 <= i <= 70:
            fileName = "../results/tpcds-99queries/q61-70/q" + str(i) + "_500.plan"
        elif 71 <= i <= 99:
            fileName = "../results/tpcds-99queries/q71-99/q" + str(i) + "_500.plan"
        # fileName = "../results/tpcds-99queries/q1-10/q" + str(i) + "_500.plan"

        # fileName = "../results/tpcds-99queries/q40-49/q"+str(i)+"_500.plan"

        # prediction for tpc-h
        # fileName = "../results/tpcds-99queries/tpch-res/q" + str(i) + "_100GB_plan.txt"
        ...
        try:
            ...
            instance_threshold=64
            for instances in range(2,instance_threshold,1):
                ...
                new_line = '{},{},{},{},{},{},{}, {},{},{},'.format(resource_config['executor_instances'],
                                                                   ...
                                                                   resource_config['executor_mem'], data_size, "Q" + str(i),
                ...
                predicted_runtime_line = '{},{},{},{},{},predicted_runtime: {} seconds'.format(resource_config['executor_instances'],
                                                                    ...
                                                                    resource_config['executor_mem'], data_size, "Q" + str(i),
                                                                    predicted_runtime)
                print("the predicted_runtime is {}".format(predicted_runtime_line))
                ...
                if predicted_runtime <= deadline:
                    print("The deadline can be met")
                    min_prediction_time = predicted_runtime
                    min_executor_instances = resource_config['executor_instances']
                    min_executor_memory = resource_config['executor_mem']
                    deadline_met="The predicted runtime by Foresight is {} seconds, which is less than the deadline {} seconds".format(min_prediction_time,deadline)
                    print(deadline_met)
                    break

            if predicted_runtime > deadline:
                print("Foresight predicts whether the deadline {} seconds of query-{} can be met at {}GB scale".format(
                    deadline, i, data_size))
                print("a deadline violation")
                # min_prediction_time = predicted_runtime
                # min_executor_instances = resource_config['executor_instances']
                # min_executor_memory = resource_config['executor_mem']

            final_predicted_runtime = 'final prediction: executor instances: {}, executor_cores: {},executor_memory:{},data_size: {},query is {},predicted_runtime: {} seconds, deadline is {} seconds'.format(
                min_executor_instances,
                resource_config['executor_cores'],
                min_executor_memory, data_size, "Q" + str(i),
                min_prediction_time,
                deadline)
    ...
    # fileName = '../results/tpcds-99queries/{}-runtime_prediction.csv'.format(prefix)
